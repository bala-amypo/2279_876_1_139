...
@Entity
@Table(name = "course_mappings", uniqueConstraints = {
        @UniqueConstraint(columnNames = {"source_course_id", "target_course_id"})
})
public class CourseMapping {
    ...
    public CourseMapping(Course sourceCourse, Course targetCourse,
